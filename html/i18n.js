var LANG = {
  en: {
    ...
    sys_save_success: 'Settings saved to Flash successfully!',
    sys_save_failed: 'Failed to save configuration to Flash!',
    sys_verify_failed: 'Configuration save verification failed!',

    login_title: 'HORACO ZX-SG4T2 custom',
    login_heading: 'HORACO ZX-SG4T2 custom',
  ...
  ja: {
    ...
    sys_save_success: '設定がフラッシュに正常に保存されました!',
    sys_save_failed: '設定のフラッシュへの保存に失敗しました!',
    sys_verify_failed: '設定の保存確認に失敗しました!',
  ...
  zh: {
    ...
    sys_save_success: '设置已成功保存到 Flash!',
    sys_save_failed: '保存配置到 Flash 失败!',
    sys_verify_failed: '配置保存验证失败!',
